#ifndef __DEFENCEWOUNDEDPLAYER_H__
#define __DEFENCEWOUNDEDPLAYER_H__

#include "decoratedplayer.h"
#include "player.h"

class DefenceWoundedPlayer : public DecoratedPlayer {
public:
    ...
    #endif
    DefenceWoundedPlayer(Player * player);
    ~DefenceWoundedPlayer();
};
