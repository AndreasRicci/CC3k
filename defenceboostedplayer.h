#ifndef __DEFENCEBOOSTEDPLAYER_H__
#define __DEFENCEBOOSTEDPLAYER_H__

#include "decoratedplayer.h"
#include "player.h"

class DefenceBoostedPlayer : public DecoratedPlayer {
public:
    ...
    #endif
    DefenceBoostedPlayer(Player * player);
    ~DefenceBoostedPlayer();
};
